...
import { Home, Calendar, History, Plus, MapPin, Users } from 'lucide-react';
  ...
  return (
    <div className="h-full min-h-[700px] md:min-h-[800px] bg-white flex flex-col">
      ...
      <div className="hidden md:block border-t border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto flex items-center justify-center gap-8 p-6">
          <button className="flex items-center gap-2 text-purple-600 px-4 py-2 rounded-xl bg-purple-50">
            <Home className="w-5 h-5" />
            <span>Home</span>
          </button>
          <button
            className="flex items-center gap-2 text-gray-400 px-4 py-2 rounded-xl opacity-50 cursor-not-allowed"
            disabled
          >
